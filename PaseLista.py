...
class PasarListaGrupo():
    ...
    def obtenerIdentificador():
        ...
        time.sleep(0.2)
        PasarListaGrupo.insertar_datos()
    def cerrar():
    ...
    def asistenciaAlumnos(mielemento):
        ...
        menubar.add_cascade(label="Menu Principal",
                            command=PasarListaGrupo.cerrar)
        ...
        monthchoosen.bind("<<ComboboxSelected>>",
                          PasarListaGrupo.selection_changed)
    ...
    def getSensorValues(self):  # lee los valores de las funciones
        ...
        while self.isRun:
            ...
            try:
                ...
                if(num == 19):
                    print("Saliendo")
                    PasarListaGrupo.obtenerIdentificador()
                    break
